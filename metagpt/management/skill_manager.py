...
class SkillManager:
    ...
    def add_skill(self, skill: Skill):
        """
        Add a skill, adding the skill to the skill pool and searchable storage
        :param skill: Skill
        :return:
        """
    ...
    def del_skill(self, skill_name: str):
        """
        Delete a skill, removing the skill from the skill pool and searchable storage
    ...
    def get_skill(self, skill_name: str) -> Skill:
        """
        Obtain the exact skill by skill name
        :param skill_name: Skill name
        :return: Skill
        """
