...
class ChromaStore:
    """If inheriting from BaseStore or introducing other modules from metagpt, a Python exception will occur, which is very strange"""
    ...
    def persist(self):
        """Chroma recommends using server mode, not local persist"""
